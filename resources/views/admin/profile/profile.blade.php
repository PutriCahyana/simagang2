        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex flex-col items-center">
                        ...
                        <div class="relative">
                            ...
                            <!-- Upload Button -->
                            <button onclick="document.getElementById('fotoProfilInput').click()" class="absolute bottom-4 right-0 bg-indigo-600 text-white p-2 rounded-full hover:bg-indigo-700 transition">
                        ...
                        <!-- Form Upload Foto -->
                        <form action="{{ route('admin.profile.update-foto') }}" method="POST" enctype="multipart/form-data" id="fotoProfilForm">
                            @csrf
                        ...
                        @if($user->foto_profil)
                        <form action="{{ route('admin.profile.delete-foto') }}" method="POST" class="mt-2">
                            @csrf
                            @method('DELETE')
                        ...
                        <div class="mt-4 w-full">
                            <div class="bg-indigo-50 rounded-lg p-3 text-center">
                                ...
                                <p class="text-sm font-semibold text-indigo-600">Admin</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <!-- Edit Mode -->
                    <form id="dataDiriEdit" action="{{ route('admin.profile.update-data-diri') }}" method="POST" class="hidden space-y-4">
                        @csrf
                        <div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <form id="usernameEdit" action="{{ route('admin.profile.update-username') }}" method="POST" class="hidden space-y-4">
                            @csrf
                            <div>
                    ...
                    <div>
                        ...
                        <form id="passwordEdit" action="{{ route('admin.profile.update-password') }}" method="POST" class="hidden space-y-4">
                            @csrf
                            <div>
