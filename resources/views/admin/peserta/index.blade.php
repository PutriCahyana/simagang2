            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" style="max-width: 200px;">Institut</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="pesertaTableBody">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200 peserta-row" 
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600" style="max-width: 200px; word-wrap: break-word; white-space: normal;">
