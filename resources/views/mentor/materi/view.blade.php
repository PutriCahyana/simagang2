...
<div class="mt-3">
    <a href="{{ route('mentor.materiEdit', $materi->materi_id) }}" class="btn btn-warning">
        <i class="fas fa-edit mr-2"></i>
        Edit Materi
    </a>
    <form action="{{ route('mentor.materiDestroy', $materi->materi_id) }}" method="POST" style="display: inline-block;" 
