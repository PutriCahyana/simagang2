...
<div class="container mx-auto px-4 py-8">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Daftar Peserta</h1>
        <p class="text-gray-600">Kelola dan pantau peserta dari room Anda</p>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="pesertaTableBody">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200 peserta-row" 
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('mentor.peserta.show', $peserta->id) }}" 
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-400 text-sm mt-1">Peserta akan muncul di sini setelah bergabung ke room Anda</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
